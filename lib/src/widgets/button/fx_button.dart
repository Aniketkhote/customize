...
class FxButton extends StatelessWidget {
  ...
  factory FxButton.success({
    ...
    EdgeInsetsGeometry? margin,
    BorderRadius? radius,
    Color? color = FxColors.success,
    List<BoxShadow>? shadow,
    Color? textColor = Colors.white,
    Color? iconColor,
    Color outlineColor = FxColors.success,
    BtnShape shape = BtnShape.rounded,
    BtnSize size = BtnSize.normal,
    BtnType type = BtnType.solid,
  }) =>
  ...
  factory FxButton.warning({
    ...
    EdgeInsetsGeometry? margin,
    BorderRadius? radius,
    Color? color = FxColors.warning,
    List<BoxShadow>? shadow,
    Color? textColor = Colors.white,
    Color? iconColor,
    Color outlineColor = FxColors.warning,
    BtnShape shape = BtnShape.rounded,
    BtnSize size = BtnSize.normal,
    BtnType type = BtnType.solid,
  }) =>
  ...
  factory FxButton.danger({
    ...
    EdgeInsetsGeometry? margin,
    BorderRadius? radius,
    Color? color = FxColors.danger,
    List<BoxShadow>? shadow,
    Color? textColor = Colors.white,
    Color? iconColor,
    Color outlineColor = FxColors.danger,
    BtnShape shape = BtnShape.rounded,
    BtnSize size = BtnSize.normal,
    BtnType type = BtnType.solid,
  }) =>
  ...
  factory FxButton.info({
    ...
    EdgeInsetsGeometry? margin,
    BorderRadius? radius,
    Color? color = FxColors.info,
    List<BoxShadow>? shadow,
    Color? textColor = Colors.white,
    Color? iconColor,
    Color outlineColor = FxColors.info,
    BtnShape shape = BtnShape.rounded,
    BtnSize size = BtnSize.normal,
    BtnType type = BtnType.solid,
  }) =>
  ...
  factory FxButton.dark({
    ...
    EdgeInsetsGeometry? margin,
    BorderRadius? radius,
    Color? color = FxColors.dark,
    List<BoxShadow>? shadow,
    Color? textColor = Colors.white,
    Color? iconColor,
    Color outlineColor = FxColors.dark,
    BtnShape shape = BtnShape.rounded,
    BtnSize size = BtnSize.normal,
    BtnType type = BtnType.solid,
  }) =>
  ...
  factory FxButton.light({
    ...
    List<BoxShadow>? shadow,
    Color? textColor = FxColors.dark,
    Color? iconColor,
    Color outlineColor = FxColors.light,
    BtnShape shape = BtnShape.rounded,
    BtnSize size = BtnSize.normal,
    BtnType type = BtnType.solid,
  }) =>
